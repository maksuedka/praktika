document.addEventListener('DOMContentLoaded', () => {
    ...
    function openOrderModal() {
        ...
        orderModal.classList.add('modal'); // Добавьте класс 'modal' для стилизации
        ...
        document.body.appendChild(orderModal); // Добавляем модальное окно в DOM
        ...
        confirmButton.addEventListener('click', () => {
            ...
            orderModal.remove(); // Закрываем модальное окно заказа
        ...
        cancelButton.addEventListener('click', () => {
            orderModal.remove(); // Закрываем модальное окно при отмене
        });
